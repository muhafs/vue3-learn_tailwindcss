<template>
	<nav class="flex items-center px-32 py-3 bg-slate-800">
		<h2 class="text-3xl font-bold mr-6 uppercase bg-gradient-to-r from-blue-500 to-teal-400 text-transparent bg-clip-text">Logo</h2>
